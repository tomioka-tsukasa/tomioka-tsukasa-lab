import { APP_NAME, BROWSER, DEVICE_TYPE, OS } from '../deviceInfoConstants'
import { BrowserInfo, BrowserInfoState } from './detectorTypes'

export const browserInfoState: BrowserInfoState = {
  info: {
    os: OS.EMPTY,
    isWebView: false,
